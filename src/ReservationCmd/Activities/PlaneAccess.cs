...
internal class PlaneAccess :  AccessAbstract<PlaneModel>
{
    public PlaneAccess(PlaneClient client, ILogger<PlaneAccess> logger)
        : base(client, logger)
{
}
}
...
//internal class PlaneAccess
//{
//    private readonly ILogger<CustomerAccess> _logger;
//    private readonly CustomerClient _client;

//    public PlaneAccess(CustomerClient client, ILogger<CustomerAccess> logger)
//    {
